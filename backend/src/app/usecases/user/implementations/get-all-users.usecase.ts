import { GetAllUsersDto, GetUserDto, ToggleDeleteUserDto, UpdateUserDto } from "../../../../domain/dtos/user/user.dto";
import { User } from "../../../../domain/entities/user";
import { UserProfile } from "../../../../domain/entities/user-profile";
import { HttpError } from "../../../../presentation/http/utils/HttpErrors";
import { IPaginatedResponse, IUserRepository } from "../../../repositories/user.repository";
