import { ICourseWithDetailsDTO, ICourseWithEnrollmentDTO } from "../../../../domain/dtos/course/course.dto";
...
export class GetCourseWithDetailsUseCase implements IGetCourseWithDetailsUseCase {
  ...
  async execute(
    ...
    const courseDetails = await this.courseRepository.findCourseDetails(course.id);
