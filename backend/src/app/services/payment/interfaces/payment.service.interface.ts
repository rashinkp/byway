...
export interface IPaymentService {
  ...
  createStripeCheckoutSession(userId: string, orderId: string, input: CreateOrderDto): Promise<ServiceResponse<{ session: { id: string; url: string; payment_status: string; amount_total: number } }>>;
