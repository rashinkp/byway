        ...
        <Card className="bg-white/80 backdrop-blur-sm border border-gray-100 shadow-sm rounded-xl p-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-2">
                <h1 className="text-2xl font-semibold text-gray-900">Instructor Wallet</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6">
              ...
              <p className="text-3xl font-bold text-gray-900">${wallet?.totalEarnings?.toFixed(2) ?? "0.00"}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wide">Total Withdrawals</h3>
              </div>
              <p className="text-3xl font-bold text-gray-900">${wallet?.totalWithdrawals?.toFixed(2) ?? "0.00"}</p>
            </div> */}
          </div>
        </Card>
