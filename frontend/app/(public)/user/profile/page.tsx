	...
	return (
		<>
			<div className="min-h-screen bg-gray-50/50 flex flex-row relative">
				{/* Sidebar for desktop */}
				<aside
					className={`hidden md:flex transition-all duration-300 ${sidebarCollapsed ? "w-14" : "w-64"} bg-white border-r border-gray-200 shadow-lg flex-col z-30`}
				>
					<Sidebar
				...
				<aside
					className={`w-14 bg-white border-r border-gray-200 shadow-lg z-20 flex flex-col md:hidden transition-all duration-300 ${!sidebarCollapsed ? "pointer-events-none opacity-0" : ""}`}
				>
					<Sidebar
						activeSection={activeSection}
						setActiveSection={handleSectionChange}
