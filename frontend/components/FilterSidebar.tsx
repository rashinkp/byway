...
export function FilterSidebar({
	...
	return (
		...
		>
			...
			{/* Sort By */}
			<div className="mb-6">
				<h3 className="text-sm font-medium text-[var(--color-primary-dark)] mb-2">
					Sort By
				</h3>
				<DropdownMenu>
							...
							<DropdownMenuItem
								...
								className={
									currentFilters.sort === option.value
										? "bg-[var(--color-background)] text-[var(--color-primary-dark)] rounded"
										: "rounded"
								}
							>
								{option.label}
			...
			<div className="mb-6">
				...
				>
					<label className="flex items-center gap-2 cursor-pointer group">
						...
						/>
						<span className="text-sm text-[var(--color-muted)] group-hover:text-[var(--color-primary-light)] data-[state=checked]:text-[var(--color-primary-light)] transition-colors">
							All Categories
						</span>
					</label>
