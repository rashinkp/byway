...
export default function ThemeDebug() {
  ...
  return (
    <div className="mt-8">
      <h2 className="text-lg font-semibold mb-2 text-[var(--foreground)]">Theme Debug</h2>
      <table className="w-full border border-[var(--border)] rounded-lg bg-[var(--background)] text-[var(--foreground)]">
        <thead>
          <tr>
            <th className="px-4 py-2 border-b border-[var(--border)] text-left font-medium">Variable</th>
            <th className="px-4 py-2 border-b border-[var(--border)] text-left font-medium">Value</th>
            <th className="px-4 py-2 border-b border-[var(--border)] text-left font-medium">Swatch</th>
          </tr>
        </thead>
        <tbody>
          {Object.entries(vars).map(([key, value]) => (
            <tr key={key} className="border-b border-[var(--border)]">
              ...
              <td className="px-4 py-2 text-[var(--muted-foreground)] font-mono">{value}</td>
