...
export default function InstructorActions({
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      APPROVED: { bg: "bg-green-50", text: "text-green-700", border: "border-green-200", icon: Check },
      REJECTED: { bg: "bg-red-50", text: "text-red-700", border: "border-red-200", icon: X },
      ENABLED: { bg: "bg-green-50", text: "text-green-700", border: "border-green-200", icon: Check },
      DISABLED: { bg: "bg-red-50", text: "text-red-700", border: "border-red-200", icon: X },
    };
        ...
        <AlertDialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
          <AlertDialogTrigger asChild>
            ...
            >
              ...
              {instructor.deletedAt ? "Enable Instructor" : "Disable Instructor"}
            </Button>
          </AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction 
                ...
                className={instructor.deletedAt ? "bg-green-600 hover:bg-green-700" : "bg-red-600 hover:bg-red-700"}
              >
