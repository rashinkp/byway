	...
	return (
		...
		>
			...
			<div className="flex flex-col flex-1">
				...
				<p className="text-xs text-gray-700 dark:text-gray-300 mb-1 line-clamp-1 text-center">
					{instructor.areaOfExpertise}
				</p>
				<p className="text-xs text-gray-500 dark:text-gray-300 line-clamp-2 text-center">
