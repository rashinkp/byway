  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <Separator />
        <div className="flex justify-between items-center">
          <span className="text-lg font-semibold text-[var(--color-primary-dark)]">Total</span>
          <span className="text-xl font-bold text-[var(--color-primary-light)]">${formatPrice(total)}</span>
        </div>
      </div>
