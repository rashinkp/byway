								...
								<div>
									<div className="flex items-center gap-2">
										...
										{method.disabled && (
											<Badge
												variant="outline"
												className="bg-[var(--color-warning)]/20 text-[var(--color-muted)] border-[var(--color-muted)]/40"
											>
									...
									>
										...
										{method.disabled && method.id === "PAYPAL" && (
											<span className="block mt-1 text-[var(--color-danger)]">
												We&apos;re working on fixing some technical issues.
												Please use other payment methods for now.
											</span>
										)}
									</p>
								</div>
