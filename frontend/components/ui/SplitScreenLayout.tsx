		...
		<div className="flex flex-col  lg:flex-row min-h-screen">
			...
			<div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-r from-primary to-primary/80">
				...
				<div className="absolute inset-0 flex flex-col justify-center items-center p-8 md:p-12 text-center z-10">
					<div className="bg-black/70 rounded-xl p-6 md:p-10 w-full max-w-xl mx-auto">
						<h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#facc15] mb-4">
							{title}
						</h2>
						<p className="text-white text-base md:text-lg max-w-md mx-auto">
							{description}
						</p>
					</div>
				</div>
