	...
	return (
		<div className="w-full space-y-6">
			<div className="bg-white dark:bg-[#232326] rounded-xl p-8 mb-8 text-center">
				<h1 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-gray-100">Wallet</h1>
			...
			{/* Balance Card */}
			<div className="bg-gradient-to-br from-yellow-400 to-yellow-200 dark:from-yellow-600 dark:to-yellow-400 rounded-xl p-6 sm:p-8 text-gray-900 dark:text-gray-900 relative overflow-hidden">
				...
				<div className="relative z-10">
					...
					<Button
						...
						className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-2 rounded-lg shadow-md"
					>
						Add Money
					</Button>
				</div>
			...
			<Dialog open={showTopUpModal} onOpenChange={setShowTopUpModal}>
				<DialogContent className="bg-white dark:bg-[#232326] rounded-xl p-6">
					<DialogHeader>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
				<div className="bg-white dark:bg-[#232326] border border-gray-200 dark:border-gray-700 rounded-xl p-6">
